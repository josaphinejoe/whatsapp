              ...
              return Padding(
                ...
                child: Padding(
                  ...
                  child: ListTile(
                    ...
                    title: Text("${contact.firstName} ${contact.lastName ?? ""}", style: const TextStyle(fontSize: 20, fontWeight: FontWeight.w500),),
                    leading: CircleAvatar(
                      backgroundColor: Colors.white,
                      backgroundImage: NetworkImage(contact.displayPicture?? "https://cdn4.iconfinder.com/data/icons/business-and-office-29/512/396-_profile__avatar__image__dp_-512.png"),
                      radius: 30,
                    ),
                  ),
                ),
