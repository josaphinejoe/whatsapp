...
class MockContactService implements ContactService
{
  ...
  Future<void> sendMessage(String receiverPhone,String msg, bool isImage) async {
    ...
    contact.chatList.add(MessageInfo(message: msg, time: DateTime.now().millisecondsSinceEpoch, isMyMsg: true, isImage: isImage));
    this._eventAggregator.publish(MessageSentEvent(contact));

       await Future.delayed(const Duration(seconds: 10),()  {
             contact.chatList.add(MessageInfo(message: "Hi, How are you?", time: DateTime.now().millisecondsSinceEpoch, isMyMsg: false));
            this._eventAggregator.publish(MessageSentEvent(contact));
        });
  ...
  List<Chat> _generateChatList(){
    return this._contactList.where((t) => t.chatList.isNotEmpty)
        .map((t) => Chat(firstName:t.firstName,lastName:t.lastName,phone:t.phone,messageInfo:t.chatList.last,displayPicture:t.displayPicture)).toList();
  }
  ...
  void _mockContactList(){
       Contact hebbaContact = Contact(firstName: 'Hebba', lastName: 'Jose', phone: '9947367259',displayPicture:"https://miro.medium.com/v2/resize:fit:800/1*avN_YJhMr_MJZ48a-RbZzw.jpeg");
        ...
        hebbaContact.chatList.add(MessageInfo(
        message: 'send me 2k',
        time: 1702009124942,
        isMyMsg: false));
    ...
    johnlyContact.chatList.add(MessageInfo(
    ...
    meghanaContact.chatList.add(MessageInfo(
    ...
    Contact roseContact = Contact(firstName: 'Rose', lastName: 'Mary', phone: '98765432345',displayPicture: "https://mastimorning.com/wp-content/uploads/2023/07/Best-HD-girls-whatsapp-dp-Pics-Images-2023.jpg");
        ...
        roseContact.chatList.add(MessageInfo(
        message: 'Hi Irene',
        time: 1702006038985,
        isMyMsg: false));
    ...
    sreeLakshmiContact.chatList.add(MessageInfo(
